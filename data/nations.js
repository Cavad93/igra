...
const INITIAL_GAME_STATE = {
  ...
  nations: {
        ...
        institutions: [
          {
            ...
            factions: [
              { name: 'Оптиматы',   seats: 180, wants: ['noble_privilege', 'tradition'],    fears: ['land_reform', 'populism'],   leader_id: null },
              { name: 'Популяры',   seats:  80, wants: ['land_reform', 'cheap_grain'],      fears: ['oligarchy', 'conscription'], leader_id: null },
              { name: 'Новые люди', seats:  40, wants: ['merit_promotion', 'trade'],        fears: ['closed_citizenship'],        leader_id: null },
            ],
          },
          {
            id: 'INST_consuls',
    ...
    numidia: {
      ...
      government: { type: 'tribal', custom_name: 'Нумидийское вождество', legitimacy: 78, stability: 55, ruler: { type: 'person', name: 'Айлимас', character_ids: [], personal_power: 75 }, institutions: [], power_resource: { type: 'prestige', current: 78, decay_per_turn: 1.5, restored_by: ['raids', 'personal_combat', 'generous_feasts'] }, elections: null, succession: null, conspiracies: null, transition_history: [], custom_mechanics: [], active_transition: null },
      regions: ['numidia'],
